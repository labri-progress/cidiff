...
class UtilsTest {
	...
	void logsim() {
		...
		assertEquals(2.5/3, Metric.logsim("A BBBB C", "A BBBC C"));  // one token different but qgram identical
		assertEquals(2.0/3, Metric.logsim("A BBBB C", "A BBBC D"));  // one token different but qgram identical and one token different but same size
		assertEquals(0.5, Metric.logsim("A BBBB C", "A BBBC DD"));  // one token different but qgram identical and one token different with different size
	}
